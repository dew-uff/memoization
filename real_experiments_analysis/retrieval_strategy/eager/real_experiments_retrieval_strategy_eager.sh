...
echo ''
echo ''
echo 'python copy_matrix_serial_speedupy.py 6250 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py copy_matrix_serial_speedupy.py
python copy_matrix_serial_speedupy.py 6250 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python copy_matrix_serial_speedupy.py 6250 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python copy_matrix_serial_speedupy.py 6250 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py copy_matrix_serial_speedupy.py
python copy_matrix_serial_speedupy.py 6250 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python copy_matrix_serial_speedupy.py 6250 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/ speedupy/
