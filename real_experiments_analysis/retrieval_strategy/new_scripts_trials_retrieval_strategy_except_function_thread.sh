...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 100 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 100 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python test_laplace_jacobi_4.py 100 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 100 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 100 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python test_laplace_jacobi_4.py 100 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 100 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 100 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python test_laplace_jacobi_4.py 100 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 100 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 100 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
python test_laplace_jacobi_4.py 100 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 125 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 125 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python test_laplace_jacobi_4.py 125 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 125 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 125 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python test_laplace_jacobi_4.py 125 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 125 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 125 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python test_laplace_jacobi_4.py 125 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 125 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 125 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
python test_laplace_jacobi_4.py 125 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 150 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 150 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python test_laplace_jacobi_4.py 150 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 150 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 150 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python test_laplace_jacobi_4.py 150 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 150 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 150 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python test_laplace_jacobi_4.py 150 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 150 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 150 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
python test_laplace_jacobi_4.py 150 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 175 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 175 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python test_laplace_jacobi_4.py 175 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 175 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 175 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python test_laplace_jacobi_4.py 175 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 175 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 175 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python test_laplace_jacobi_4.py 175 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 175 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 175 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
python test_laplace_jacobi_4.py 175 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 200 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 200 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python test_laplace_jacobi_4.py 200 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python test_laplace_jacobi_4.py 200 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py test_laplace_jacobi_4.py
python test_laplace_jacobi_4.py 200 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python test_laplace_jacobi_4.py 200 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py mov_robots_speedupy.py
python mov_robots_speedupy.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python mov_robots_speedupy.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py mov_robots_speedupy.py
python mov_robots_speedupy.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python mov_robots_speedupy.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py mov_robots_speedupy.py
python mov_robots_speedupy.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python mov_robots_speedupy.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_1.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py mov_robots_speedupy_1.py
python mov_robots_speedupy_1.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python mov_robots_speedupy_1.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_1.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py mov_robots_speedupy_1.py
python mov_robots_speedupy_1.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python mov_robots_speedupy_1.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_1.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py mov_robots_speedupy_1.py
python mov_robots_speedupy_1.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python mov_robots_speedupy_1.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_1.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py mov_robots_speedupy_1.py
python mov_robots_speedupy_1.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
python mov_robots_speedupy_1.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_2.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py mov_robots_speedupy_2.py
python mov_robots_speedupy_2.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python mov_robots_speedupy_2.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_2.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py mov_robots_speedupy_2.py
python mov_robots_speedupy_2.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python mov_robots_speedupy_2.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_2.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py mov_robots_speedupy_2.py
python mov_robots_speedupy_2.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python mov_robots_speedupy_2.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_2.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py mov_robots_speedupy_2.py
python mov_robots_speedupy_2.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
python mov_robots_speedupy_2.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_3.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py mov_robots_speedupy_3.py
python mov_robots_speedupy_3.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python mov_robots_speedupy_3.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_3.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py mov_robots_speedupy_3.py
python mov_robots_speedupy_3.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python mov_robots_speedupy_3.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_3.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py mov_robots_speedupy_3.py
python mov_robots_speedupy_3.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python mov_robots_speedupy_3.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_3.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py mov_robots_speedupy_3.py
python mov_robots_speedupy_3.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
python mov_robots_speedupy_3.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_4.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py mov_robots_speedupy_4.py
python mov_robots_speedupy_4.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python mov_robots_speedupy_4.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_4.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py mov_robots_speedupy_4.py
python mov_robots_speedupy_4.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python mov_robots_speedupy_4.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_4.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py mov_robots_speedupy_4.py
python mov_robots_speedupy_4.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python mov_robots_speedupy_4.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python mov_robots_speedupy_4.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py mov_robots_speedupy_4.py
python mov_robots_speedupy_4.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
python mov_robots_speedupy_4.py --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
rm -rf .speedupy/ speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 900 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 900 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python eq_solver_speedupy.py 900 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 900 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 900 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python eq_solver_speedupy.py 900 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 900 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 900 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python eq_solver_speedupy.py 900 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 900 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 900 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
python eq_solver_speedupy.py 900 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 800 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 800 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python eq_solver_speedupy.py 800 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 800 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 800 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python eq_solver_speedupy.py 800 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 800 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 800 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python eq_solver_speedupy.py 800 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 800 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 800 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
python eq_solver_speedupy.py 800 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 700 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 700 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python eq_solver_speedupy.py 700 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 700 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 700 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python eq_solver_speedupy.py 700 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 700 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 700 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python eq_solver_speedupy.py 700 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 700 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 700 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
python eq_solver_speedupy.py 700 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 600 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 600 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python eq_solver_speedupy.py 600 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 600 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 600 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python eq_solver_speedupy.py 600 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 600 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 600 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python eq_solver_speedupy.py 600 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python eq_solver_speedupy.py 600 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py eq_solver_speedupy.py
python eq_solver_speedupy.py 600 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
python eq_solver_speedupy.py 600 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
rm -rf .speedupy/ speedupy/
...
echo ''
echo ''
echo 'python power.py 1241231000 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py power.py
python power.py 1241231000 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python power.py 1241231000 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python power.py 1241231000 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py power.py
python power.py 1241231000 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python power.py 1241231000 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python power.py 1241231000 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py power.py
python power.py 1241231000 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python power.py 1241231000 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python power.py 1241231000 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py power.py
python power.py 1241231000 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
python power.py 1241231000 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python power.py 124123124 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py power.py
python power.py 124123124 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
python power.py 124123124 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python power.py 124123124 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread'
python speedupy/setup_exp/setup.py power.py
python power.py 124123124 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
python power.py 124123124 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy eager --retrieval-exec-mode thread
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python power.py 124123124 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py power.py
python power.py 124123124 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
python power.py 124123124 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy lazy --retrieval-exec-mode sequential
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python power.py 124123124 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential'
python speedupy/setup_exp/setup.py power.py
python power.py 124123124 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
python power.py 124123124 462 --exec-mode manual --num-dict 2 -s db --retrieval-strategy function --retrieval-exec-mode sequential
rm -rf .speedupy/
