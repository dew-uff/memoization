...
echo ''
echo ''
echo 'python copy_matrix_serial_speedupy.py 6250 --exec-mode manual --num-dict 0'
...
python copy_matrix_serial_speedupy.py 6250 --exec-mode manual --num-dict 0
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python copy_matrix_serial_speedupy.py 6250 --exec-mode manual --num-dict 1'
echo "Starting copy_matrix_serial_speedupy.py (8/18)" | mail -s "Phoenix - Trial 10" joaolopez@id.uff.br
python speedupy/setup_exp/setup.py copy_matrix_serial_speedupy.py
python copy_matrix_serial_speedupy.py 6250 --exec-mode manual --num-dict 1
rm -rf .speedupy/ speedupy/
...
echo ''
echo ''
echo 'python metropolis_hastings.py 120000 --exec-mode manual --num-dict 0'
...
python metropolis_hastings.py 120000 --exec-mode manual --num-dict 0
rm -rf .speedupy/
...
echo ''
echo ''
echo 'python metropolis_hastings.py 120000 --exec-mode manual --num-dict 1'
echo "Starting metropolis_hastings.py (16/18)" | mail -s "Phoenix - Trial 10" joaolopez@id.uff.br
python speedupy/setup_exp/setup.py metropolis_hastings.py
python metropolis_hastings.py 120000 --exec-mode manual --num-dict 1
rm -rf .speedupy/ speedupy/
