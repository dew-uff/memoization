...
conda activate pilots-env
python speedupy/setup_exp/setup.py power.py
python power.py 1241231000 430 -s db --exec-mode manual
rm -rf .speedupy/ speedupy/
...
conda activate pilots-env
python speedupy/setup_exp/setup.py power.py
python power.py 124123124 400 -s db --exec-mode manual
rm -rf .speedupy/ speedupy/
...
python test_laplace_jacobi_1.py 10 -s db --exec-mode manual
rm -rf .speedupy/ speedupy/
...
python test_laplace_jacobi_2.py 10 -s db --exec-mode manual
rm -rf .speedupy/ speedupy/
...
python test_laplace_jacobi_3.py 10 -s db --exec-mode manual
rm -rf .speedupy/ speedupy/
...
python test_laplace_jacobi_4.py 10 -s db --exec-mode manual
rm -rf .speedupy/ speedupy/
...
python test_laplace_jacobi_5.py 10 -s db --exec-mode manual
rm -rf .speedupy/ speedupy/
...
python eq_solver_speedupy_1.py 1000 -s db --exec-mode manual
rm -rf .speedupy/ speedupy/
...
python eq_solver_speedupy_2.py 1000 -s db --exec-mode manual
rm -rf .speedupy/ speedupy/
...
python eq_solver_speedupy_3.py 1000 -s db --exec-mode manual
rm -rf .speedupy/ speedupy/
...
python eq_solver_speedupy_4.py 1000 -s db --exec-mode manual
rm -rf .speedupy/ speedupy/
